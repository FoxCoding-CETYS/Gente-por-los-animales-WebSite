...
export function CustomCard({
  ...
  return (
    <div
      className={`flex flex-col items-center justify-center text-center shadow-md rounded-[10px] border border-gray-200 bg-white lg:w-10/12 ${className}`}
      onClick={onClick}
    >
      {icon && <img src={icon} alt="" className="mb-2" />}
      ...
      <div className="w-[1173px]">
        ...
        <div className="flex flex-row">
          {text1 && <p className="text-[20px] w-[454px] pt-[20px] font-light">{text1}</p>}
          {text2 && <p className="text-[20px] w-[454px] pt-[20px] font-light">{text2}</p>}
          {text3 && <p className="text-[20px] w-[454px] pt-[20px] font-light">{text3}</p>}
        </div>
        <div className="flex flex-row">
