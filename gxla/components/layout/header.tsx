...
export function Header(){
    ...
    return(
        <nav className="fixed top-0 left-0 w-screen bg-white backdrop-blur-md z-1000 shadow-sm shadow-[#00A63E] text-black">
            ...
            height={74}
            />
            <ul className="hidden md:flex justify-end space-x-5 gap-5 items-center">
                <li className="text-[20px] hover:underline hover:underline-offset-4 hover:decoration-[#06F180] transition-all duration-300 hover:scale-105 origin-center">
                ...
                <li className="text-[20px] bg-[#06F180] shadow-lg py-2 px-4 font-bold rounded-2xl transition-all hover:scale-105 cursor-pointer">
