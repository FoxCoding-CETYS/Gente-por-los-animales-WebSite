...
export default function NosotrosPage() {
    ...
    return(
        <>
            {/* Hero Section */}
            <div className="flex flex-col items-center justify-center lg:py-16 py-8 w-screen bg-[#05DF72] text-black text-center gap-6">
            ...
            <div className="w-screen flex flex-col items-center text-center px-4 gap-4">
                ...
                <p className="lg:w-9/12 lg:text-[20px] text-[16px] text-left leading-9">
                ...
                { completo && <p className="lg:w-9/12 lg:text-[20px] text-[16px] text-left leading-9">La apertura del Centro Municipal de Control Animal de Mexicali en el año 2006, detonó nuestra intención de hacer algo, obligándonos a actuar para brindarles una segunda oportunidad a estos animales, que de otra manera serían capturados y sacrificados. <br /><br />
            ...
            <div className=" flex bg-[#F9FAFB] w-screen flex-col justify-center">
                ...
                {/* Valores */}
                <div className=" flex bg-[#F9FAFB] w-screen flex-row justify-center items-center gap-10 lg:py-20 sm:py-10 lg:flex-row sm:flex-col">
            ...
            <div className="flex flex-col justify-center items-center">
                <h1 className="font-geist text-black lg:text-6xl font-bold mt-10 text-[24px]"> OBJETIVOS </h1>
                <div className="grid lg:grid-cols-2 grid-cols-1 justify-items-center mt-8 mb-5 px-6">
                    <ul className="list-disc w-10/12">
                        <li className="lg:text-[20px] text-[16px]">Reubicar con familias responsables y cariñosas, a través del programa de adopción, a aquellos animales que han sido rescatados de la calle, abandonados, maltratados y/o que otras personas ya no pueden cuidar.</li><br />
                        <li className="lg:text-[20px] text-[16px]">Incrementar la cantidad de perros y gatos esterilizados.</li><br />
                        <li className="lg:text-[20px] text-[16px]">Concientizar sobre las necesidades de los animales de compañía y el respeto hacia los mismos.</li><br />
                        <li className="lg:text-[20px] text-[16px]">Educar sobre bienestar animal y la importancia de la esterilización de los animales de compañía.</li><br />
                        <li className="lg:text-[20px] text-[16px]">Promover reglas básicas para una convivencia respetuosa entre los guardianes de animales y el resto de la sociedad.</li><br />
                        <li className="lg:text-[20px] text-[16px]">Supervisar la aplicación del marco jurídico relacionado con el bienestar animal.</li><br />
                    </ul>
                    <ul className="list-disc w-10/12">
                        <li className="lg:text-[20px] text-[16px]">Impulsar la utilización de métodos humanitarios para la captura y la matanza de animales de compañía.</li><br />
                        <li className="lg:text-[20px] text-[16px]">Incidir en políticas públicas para el control ético de la población canina y felina.</li><br />
                        <li className="lg:text-[20px] text-[16px]">Participar con las autoridades de los distintos órdenes de gobierno, competentes para atender asuntos de bienestar animal.</li><br />
                        <li className="lg:text-[20px]">Fomentar la participación ciudadana en temas relacionados con el bienestar animal.</li><br />
                        <li className="lg:text-[20px]">Vincularse con instituciones académicas, asociaciones de profesionistas y el sector empresarial.</li><br />
                        <li className="lg:text-[20px]">Colaborar con organismos de la sociedad civil que promuevan valores similares a los nuestros.</li><br />
                    </ul>
                </div>
            </div>
            {/* Alianzas estrategicas */}
            <div className="bg-[#F9FAFB] flex flex-col justify-center items-center">
                <h1 className="font-geist text-black lg:text-6xl font-bold mt-10 text-[24px] text-center"> ALIANZAS ESTRATÉGICAS </h1>
                <div className="grid grid-cols-2 lg:grid-cols-4 p-8 gap-5 lg:gap-15 justify-center">
                    <CustomCard variant="vertical" size="md" icon="/Circle.png" title="Clínica y Estética Canina">Atención médica para animales en adopción y programas de esterilización</CustomCard>
                    <CustomCard variant="vertical" size="md" icon="/Circle.png" title="Pet Zone">Clínica veterinaria participante en programas de esterilización</CustomCard>
                    <CustomCard variant="vertical" size="md" icon="/Circle.png" title="DIFOSA">Facilita almacén para resguardo y distribución de donativos</CustomCard>
                    <CustomCard variant="vertical" size="md" icon="/Circle.png" title="Spay México">Coorganizadora de campañas de esterilización</CustomCard>
                </div>
            </div>
            {/* Patrocinadores */}
            <div className="flex flex-col justify-center items-center">
                <h1 className="font-geist text-black text-6xl font-bold mt-10 text-[24px]"> PATROCINADORES </h1>
                <div className="grid grid-cols-2 lg:grid-cols-4 p-8 gap-10 mt-2 mb-8">
                    ...
                    <div className="lg:w-44 lg:h-44 w-35 h-35 bg-[#F2F2F2] flex items-center justify-center">
                        <p className="font-bold lg:text-[32px] text-[20px] text-center">Zayda Torres</p>
                    </div>
                    <div className="lg:w-44 lg:h-44 w-35 h-35 bg-[#F2F2F2] flex items-center justify-center">
                        <p className="font-bold lg:text-[32px] text-[20px] text-center">La Casa de Lolo Café & Matcha</p>
                    </div>
                    <div className="lg:w-44 lg:h-44 w-35 h-35 bg-[#F2F2F2] flex items-center justify-center">
                        <p className="font-bold lg:text-[32px] text-[20px] text-center">Mega Homes</p>
                    </div>
                </div>
            </div>
            {/* Financiamiento */}
            <div className="bg-[#F9FAFB] flex flex-col justify-center items-center">
                <h1 className="font-geist text-black text-6xl font-bold p-10 text-[24px]"> FINANCIAMIENTO </h1>
