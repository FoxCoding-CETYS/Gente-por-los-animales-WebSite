...
export default function NosotrosPage() {
    return(
        <>
            {/* Hero Section */}
            <div className="flex flex-col items-center justify-center lg:py-24 py-24 px-3 mt-12 w-screen lg:bg-[#05DF72] md:bg-amber-200 bg-amber-600 text-black text-center gap-6">
                <h1 className="font-geist text-black lg:text-[64px] font-bold md:text-[50px] text-[32px]"> ¿Quiénes somos? </h1>
                <p className="lg:text-3xl lg:w-7/12 w-11/12 text-[20px]"> Conoce nuestra historia, misión y los valores que nos impulsan a trabajar por el bienestar animal. </p>
            </div>
            {/* Historia */}
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className="flex flex-row mr-24 ml-24 mt-8 mb-8 gap-20">
